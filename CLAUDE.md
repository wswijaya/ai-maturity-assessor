...
A stateful CLI agent that conducts structured stakeholder interviews based on
**AI Maturity Model**, scores responses across 6 dimensions, and produces
...
4. **Never lead the witness.** Do not suggest answers or frame questions with
   desirable outcomes (e.g., "Do you have a _mature_ data governance process?").
